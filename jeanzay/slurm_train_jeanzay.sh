...
# Start training
#srun /linkhome/rech/genrce01/user/HE2CellType/HE2CT/cell_segmentation/run_cellvit.py --config /lustre/fswork/projects/rech/user/HE2CellType/HE2CT/trainings/training_13/training_13_cellvit.yaml

# Restart training from a previous checkpoint
srun /linkhome/rech/genrce01/user/HE2CellType/HE2CT/cell_segmentation/run_cellvit.py --config /lustre/fswork/projects/rech/user/HE2CellType/HE2CT/trainings/training_11/training_11_cellvit.yaml --checkpoint /lustre/fswork/projects/rech/user/HE2CellType/HE2CT/trainings/training_11/log/2025-01-31T180049_training_11/checkpoints/checkpoint_32.pth