...
srun /linkhome/rech/genrce01/user/HE2CellType/HE2CT/cell_segmentation/inference/inference_cellvit_experiment_pannuke.py --run_dir /lustre/fswork/projects/rech/user/HE2CellType/HE2CT/prepared_datasets_cat_20x/do_patch_eval --checkpoint_name CellViT-SAM-H-x20.pth --gpu 0 --magnification 20