...
def select_dataset(
    dataset_name: str, split: str, dataset_config: dict, transforms: Callable = None, cell_tokens: str = 'no',
) -> Dataset:
    ...
    if dataset_name.lower() == "pannuke":
        ...
        dataset = PanNukeDataset(
            ...
            orig_class_names=dataset_config.get("orig_class_names", None),
            grouping=dataset_config.get("grouping", None),
            new_class_mapping=dataset_config.get("new_class_mapping", None),
            macenko_normalization=dataset_config.get("macenko_normalization", False),
        )
